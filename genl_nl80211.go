...
var channelPolicy Policy = MapPolicy{
	...
	Rule: map[uint16]Policy{
		...
		NL80211_FREQUENCY_ATTR_GO_CONCURRENT: FlagPolicy,
	...
	Rule: map[uint16]Policy{
		...
		NL80211_ATTR_SURVEY_INFO: MapPolicy{
			...
			Rule: map[uint16]Policy{
				...
				NL80211_SURVEY_INFO_CHANNEL_TIME:          U64Policy,
				NL80211_SURVEY_INFO_CHANNEL_TIME_BUSY:     U64Policy,
				NL80211_SURVEY_INFO_CHANNEL_TIME_EXT_BUSY: U64Policy,
				NL80211_SURVEY_INFO_CHANNEL_TIME_RX:       U64Policy,
				NL80211_SURVEY_INFO_CHANNEL_TIME_TX:       U64Policy,
			},
		},
